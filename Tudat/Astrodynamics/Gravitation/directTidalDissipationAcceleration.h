...
public:
    ...
    */
    ...
    //! Function to retrieve the current acceleration vector, as computed by last call to updateMembers function.
    /*!
     * Function to retrieve the current acceleration vector, as computed by last call to updateMembers function.
     * \return Current acceleration vector, as computed by last call to updateMembers function.
     */
