...
int main( )
{
    ...
    {
        boost::shared_ptr< SP3cFileContents > fileContents = readSp3cFile( baseFolder + "graA.2004-02-0" + std::to_string( test ) + ".sp3" );
        ...
        tudat::input_output::writeDataMapToTextFile(
                    inertialStateHistory,
                    "graA.2004-02-0" + std::to_string( test ) + ".dat" );
