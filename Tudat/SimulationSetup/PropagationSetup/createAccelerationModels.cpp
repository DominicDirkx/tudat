        ...
        else
        {
            ...
            accelerationModel =
                    ...
                    ( boost::bind( &Body::getPositionByReference, bodyUndergoingAcceleration, _1 ),
                      ...
                      boost::bind( &SphericalHarmonicsGravityField::getCosineCoefficientsByReference,
                                   sphericalHarmonicsGravityField, _1,
                                   sphericalHarmonicsSettings->maximumDegree_,
                                   sphericalHarmonicsSettings->maximumOrder_ ),
                      boost::bind( &SphericalHarmonicsGravityField::getSineCoefficientsByReference,
                                   sphericalHarmonicsGravityField, _1,
                                   sphericalHarmonicsSettings->maximumDegree_,
                                   sphericalHarmonicsSettings->maximumOrder_ ),
                      boost::bind( &Body::getPositionByReference, bodyExertingAcceleration, _1 ),
    ...
    else
    {
        ...
        else
        {
            ...
            accelerationModel = boost::make_shared< MutualSphericalHarmonicsGravitationalAccelerationModel >(
                        ...
                        boost::bind( &SphericalHarmonicsGravityField::getCosineCoefficientsByReference,
                                     sphericalHarmonicsGravityFieldOfBodyExertingAcceleration,_1,
                        ...
                        boost::bind( &SphericalHarmonicsGravityField::getSineCoefficientsByReference,
                                     ...
                                     mutualSphericalHarmonicsSettings->maximumOrderOfBodyExertingAcceleration_ ),
                        boost::bind( &SphericalHarmonicsGravityField::getCosineCoefficientsByReference,
                                     sphericalHarmonicsGravityFieldOfBodyUndergoingAcceleration, _1,
