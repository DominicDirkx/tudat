...
//                                                           Eigen::AngleAxisd( 0.001, Eigen::Vector3d::UnitX( ) ) *
//                                                           Eigen::AngleAxisd( 0.4, Eigen::Vector3d::UnitZ( ) ) ), 0.0, 0.0 );
        ...
        //                                                   Eigen::AngleAxisd( mathematical_constants::PI * 3.0 / 8.0, Eigen::Vector3d::UnitZ( ) ) ), 0.0, 0.0 );
                ...
                bodySettings[ "Jupiter" ]->rotationModelSettings = boost::make_shared<
                        SimpleRotationModelSettings >( "ECLIPJ2000", "IAU_Jupiter_SIMPLIFIED", Eigen::Quaterniond(
                                                           ...
                                                           Eigen::AngleAxisd( 0.5, Eigen::Vector3d::UnitZ( ) ) ), 0.0, 0.0 );
...
//                                                   Eigen::Matrix3d::Identity( ) ), 0.0, 0.0 );
...

        {
            ...
            boost::shared_ptr< TorqueSettings > sphericalHarmonicTorqueSettings = boost::make_shared< SphericalHarmonicTorqueSettings >(
                        2, 2 );
            boost::shared_ptr< TorqueSettings > extendedBodyTorqueSettings = boost::make_shared< MutualExtendedBodySphericalHarmonicTorqueSettings >(
                        getExtendedSinglePointMassInteractions( 2, 2, 0, 0, false ) );
            boost::shared_ptr< TorqueSettings > oppositeExtendedBodyTorqueSettings = boost::make_shared< MutualExtendedBodySphericalHarmonicTorqueSettings >(
                        getExtendedSinglePointMassInteractions( 0, 0, 2, 2, false ) );
            ...
            std::cout<<" Full torque: "<<extendedGravityTorque->getTorqueOnBodyExertingTorque( ).transpose( )<<std::endl;

            std::cout<<" Full torque: "<<oppositeExtendedGravityTorque->getTorque( ).transpose( )<<std::endl;
            std::cout<<" Full torque: "<<oppositeExtendedGravityTorque->getTorqueOnBodyExertingTorque( ).transpose( )<<std::endl;

            std::cout<<" Full torque: "<<extendedGravityTorque->getTorque( ).norm( )<<std::endl;
            std::cout<<" Full torque: "<<extendedGravityTorque->getTorqueOnBodyExertingTorque( ).norm( )<<std::endl;

            std::cout<<" Full torque: "<<oppositeExtendedGravityTorque->getTorque( ).norm( )<<std::endl;
            std::cout<<" Full torque: "<<oppositeExtendedGravityTorque->getTorqueOnBodyExertingTorque( ).norm( )<<std::endl;
